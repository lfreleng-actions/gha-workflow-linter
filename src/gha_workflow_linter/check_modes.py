...
Defect findings are unaffected by either axis, in every mode that runs
the check: they are wrong now, they always count towards the exit code,
and no mode downgrades them; see :mod:`gha_workflow_linter.exit_codes`.
